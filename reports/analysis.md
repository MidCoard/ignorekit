...
The first pass created a standards repo and then evolved it into `ignorekit`: a cross-platform component/preset/project-custom `.gitignore` composer.
...
Current recommendations are generated by:
